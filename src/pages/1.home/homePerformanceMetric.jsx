    ...
    <section className="relative w-full min-h-[620px] md:min-h-[680px] xl:min-h-[780px] 2xl:min-h-[900px] flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl 2xl:max-w-screen-2xl mx-auto w-full px-8 md:px-12 lg:px-20 xl:px-24 2xl:px-32 pt-16 md:pt-20 pb-4 md:pb-6 flex flex-col">
        ...
        >
          ...
          <motion.span
            variants={fadeUp}
            className="text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg font-primary font-bold text-brand-gold uppercase tracking-[0.3em] mb-8"
          >
          ...
          <motion.div variants={fadeUp}>
            <Link
              ...
              className="inline-flex items-center bg-brand-gold text-brand-dark font-primary font-bold text-[11px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg uppercase tracking-[0.2em] px-8 py-4 rounded-full hover:bg-brand-gold/90 transition-all duration-300 hover:scale-105 shadow-lg"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8">
            {METRICS.map((metric, index) => (
              ...
              >
                ...
                <span className="text-[9px] md:text-[10px] lg:text-xs xl:text-sm 2xl:text-base font-primary font-bold text-brand-white/50 uppercase tracking-[0.2em]">
                  {metric.label}
                </span>
              </div>
            ))}
