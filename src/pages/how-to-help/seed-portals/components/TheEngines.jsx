      ...
      <div className="max-w-7xl mx-auto px-8 md:px-24">
        ...
        >
          {ENGINES.map((engine) => (
            ...
            >
              <div className="mb-6">
                <p className="text-[10px] font-bold text-gray-400 font-secondary uppercase tracking-[0.15em] mb-2">
                  {engine.subtitle}
                </p>
              ...
              >
                ...
                {engine.id === "1k-club" && (
                  <span className="relative z-10 text-[10px] font-secondary uppercase tracking-widest mt-2 opacity-80 font-bold">
                    Weekly
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col grow">
                ...
                <div className="mt-auto pt-4">
                  {engine.actionType === "modal" ? (
                    ...
                    <Link
                      to={engine.linkTo}
                      className="w-full border-2 border-brand-teal text-brand-teal hover:bg-brand-teal hover:text-brand-white font-bold text-[11px] md:text-xs py-4 px-6 rounded-full transition-colors uppercase tracking-widest cursor-pointer flex items-center justify-center gap-2"
                    >
                      {engine.buttonLabel}
                    </Link>
                  )}
