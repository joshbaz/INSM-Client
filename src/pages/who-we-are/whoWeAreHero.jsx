  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full">
        <motion.div
          className="bg-white/70 backdrop-blur-md flex flex-col justify-center items-center p-8 md:p-14 text-center w-full shadow-sm border-t border-white/50"
          initial="hidden"
          animate="visible"
        ...
        >
          <motion.h1
            variants={fadeUp}
            className="text-4xl md:text-6xl lg:text-7xl font-bold font-primary text-brand-dark uppercase tracking-tight mb-4 md:mb-6 leading-tight max-w-5xl mx-auto"
          >
            The National <br className="hidden md:block" /> Economic Engine
          </motion.h1>
          <motion.p
            variants={fadeUp}
            className="text-base md:text-xl font-secondary text-brand-dark-400 font-semibold max-w-4xl mx-auto leading-relaxed"
          >
