...
const STEPS = [
  { 
    label: "The Seed", 
    description: "Your investment arrives.",
    icon: <img src="/icons/theSeed.png" alt="The Seed" className="w-16 h-16 object-contain" /> 
  },
  { 
    label: "Equipping", 
    description: "A mother is trained, and joined to a SACCO",
    ...
    <section className="w-full py-20 bg-white">
      <div className="max-w-7xl mx-auto px-8 md:px-24 text-center">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 md:gap-2 relative z-10">
