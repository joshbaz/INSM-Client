        ...
        >
          ...
          <div className="p-5 md:p-7 overflow-y-auto custom-scrollbar flex-1 flex flex-col items-center text-center">
            ...
            <div className="space-y-3 w-full">
              <div className="text-brand-dark/80 leading-relaxed font-secondary text-xs md:text-sm lg:text-base xl:text-lg 2xl:text-xl">
              ...
              <div className="pt-2 flex justify-center">
                <button
                  ...
                  className="bg-brand-lilac text-brand-white py-2.5 px-7 rounded-full font-bold uppercase tracking-widest text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg hover:bg-brand-lilac-600 transition-all shadow-md shadow-brand-lilac/20 active:scale-[0.98] cursor-pointer"
                >
