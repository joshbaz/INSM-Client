...
import ContinueWithPesapal from "../../Partner-with-us-Page/donationModel/ContinueWithPesapal";
    ...
    <div className="w-full md:max-w-[400px] bg-brand-white-100 rounded-xl shadow-lg flex flex-col overflow-hidden shrink-0">
      ...
      <div className="flex md:hidden items-center gap-3 p-4 bg-brand-white-200/50 border-b border-brand-dark-200/30">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg font-secondary text-brand-dark-400 uppercase tracking-widest truncate">
            Liquidity Engine V1
          </p>
        </div>
      </div>
        ...
        {step === "donation" ? (
          <div className="flex flex-col h-full">
            ...
            <div className="text-center mb-10 border-b border-brand-dark/5 pb-6">
              <p className="text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg font-secondary text-brand-dark-400 uppercase tracking-widest mb-2">
            ...
            <div className="flex flex-col items-center justify-center py-8 bg-brand-white-200/40 rounded-xl mb-10 grow border border-brand-dark/5">
              <span className="text-[9px] md:text-[10px] lg:text-xs xl:text-sm 2xl:text-base font-primary font-bold text-brand-lilac uppercase tracking-[0.3em] mb-2 opacity-80">
                Deployment Amount
              </span>
              ...
              <p className="text-[9px] md:text-[10px] lg:text-xs xl:text-sm 2xl:text-base font-secondary text-brand-dark-400 uppercase tracking-widest font-bold">
            ...
            <div className="mt-auto">
              ...
              <p className="text-center text-[8px] md:text-[9px] lg:text-[10px] xl:text-xs 2xl:text-sm font-secondary text-brand-dark-300 uppercase leading-relaxed max-w-[280px] mx-auto opacity-70 mt-4">
