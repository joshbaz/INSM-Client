...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-navy-900 flex items-center justify-center relative overflow-hidden py-20 px-4">
      ...
      >
        <motion.div variants={fadeUp} className="text-center mb-10">
          <div className="inline-block bg-brand-white rounded-full p-2 shadow-lg border border-brand-gold/20 mb-6">
            <img
              src="/logo.png"
          ...
          <h1 className="text-3xl font-primary font-black text-brand-white uppercase tracking-tight mb-2">
            Partner <span className="text-brand-gold">Login</span>
          </h1>
          <p className="text-brand-white/60 font-secondary text-sm">
            Access the Institutional Deployment Terminal
          </p>
        </motion.div>
            ...
            {({ isSubmitting, errors, touched }) => (
              <Form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Field
                      type="email"
                      name="email"
                      placeholder="partner@insmuganda.org"
                      className={`w-full bg-brand-white/5 border rounded-sm pl-12 pr-4 py-4 text-sm font-secondary text-brand-white placeholder:text-brand-white/20 focus:bg-brand-white/10 outline-none transition-all ${
                        errors.email && touched.email
                          ? "border-red-500/50"
                          : "border-brand-white/10 focus:border-brand-gold/50"
                      }`}
                    />
                  </div>
                  <ErrorMessage
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <a
                      ...
                      className="text-[9px] font-primary font-bold text-brand-gold/60 hover:text-brand-gold uppercase tracking-wider transition-colors"
                    >
                      Forgot?
                    </a>
                  </div>
                ...
                <button
                  ...
                  className="w-full bg-brand-gold text-brand-dark-900 font-primary font-bold text-xs uppercase tracking-[0.2em] py-4 rounded-full hover:bg-brand-gold/90 transition-all cursor-pointer flex items-center justify-center gap-3 shadow-lg shadow-brand-gold/10 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <div className="w-5 h-5 border-2 border-brand-dark-900 border-t-transparent rounded-full animate-spin"></div>
                  ) : (
                    <>
                      <Icon
        ...
        <motion.div variants={fadeUp} className="mt-8 text-center">
          ...
          <div className="mt-6">
            <a
              href="/"
              className="text-[10px] font-primary font-bold text-brand-white/30 hover:text-brand-gold uppercase tracking-[0.3em] transition-colors inline-flex items-center gap-2"
            >
